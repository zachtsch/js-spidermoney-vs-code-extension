...
## Windows
Downloads the SpiderMonkey shell from a pinned Firefox ESR release and unzips it in `C:\spidermonkey`. Then it updates your **user** `Path` so future terminals can find `js`. Finally it removes the `.zip` file.
